    ...
    <div>
      ...
      <div className='flex gap-2 justify-between flex-col items-center'>
        ...
        <div className='w-full mt-5'>
          <div className='flex items-center gap-5 p-3 border-b-2'>
            ...
            <div>
              ...
              <p className='text-sm text-gray-600'>{pickupParts.subtitle}</p>
            </div>
          </div>
        ...
        <button onClick={() => {
          ...
          props.setConfirmRidePanel(false)
          props.createRide()
        }} className='w-full mb-5 mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg'>Confirm</button>
      </div>
    </div>
  );
};
