      ...
      <h5 className='p-1 text-center w-[93%] absolute top-0' onClick={()=>{
          ...
          <div onClick={() => {
            ...
            <div className=' ml-1 w-1/2'>
              ...
              <h5 className='font-medium text-sm'>{props.eta? `${Math.floor(props.eta / 60) > 0 ? `${Math.floor(props.eta / 60)} hr${Math.floor(props.eta / 60) > 1 ? 's' : ''} ` : ''}${props.eta % 60} min${props.eta % 60 !== 1 ? 's' : ''} away`: '...'}</h5>
